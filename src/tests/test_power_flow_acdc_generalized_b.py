...
from GridCalEngine.Simulations.PowerFlow.Formulations.pf_generalized_formulationB import PfGeneralizedFormulationB
...
def solve_generalized(grid: gce.MultiCircuit,
                      options: PowerFlowOptions) -> Tuple[PfGeneralizedFormulationB, NumericPowerFlowResults]:
    """
    ...
    problem = PfGeneralizedFormulationB(V0=Vbus,
                                        S0=S0,
                                        I0=I0,
                                        Y0=Y0,
                                        Qmin=Qmin_bus,
