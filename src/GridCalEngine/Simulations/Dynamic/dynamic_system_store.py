...
from GridCalEngine.Simulations.Dynamic.dynamic_compiler import SET
from GridCalEngine.Simulations.Dynamic.time_domain_simulation import TimeDomainSimulation



class DynamicSystemStore:
    """
    ...
    def __init__(self, dynamic_grid):
        ...
        try:
            self.tds = TimeDomainSimulation(self)  # Time-domain simulation engine.
        except Exception as e:
