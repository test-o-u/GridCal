...
def g_update(P_end, P_origin, Q_end, Q_origin, b, bsh, g):
    return array([[-Q_end*Q_origin*(-b*sin(P_end - P_origin) + g*cos(P_end - P_origin)) + Q_origin**2*g], [-Q_end*Q_origin*(-b*cos(P_end - P_origin) - g*sin(P_end - P_origin)) - Q_origin**2*(b + (1/2)*bsh)], [Q_end**2*g - Q_end*Q_origin*(b*sin(P_end - P_origin) + g*cos(P_end - P_origin))], [-Q_end**2*(b + (1/2)*bsh) - Q_end*Q_origin*(-b*cos(P_end - P_origin) + g*sin(P_end - P_origin))]])
